...
<body>
	...
	<div class="searchResult">
		搜尋結果共 ${totalRows} 筆，頁數 ${whichPage} / ${totalPages}：
				...
				<span><a href="DisplayProducts?action=getOne_For_Display&pId=${product.p_no}">${product.p_name}${product.p_sales}</a></span> ${product.p_winery}${product.p_area}${product.p_price}${product.p_rate}${product.p_sales}</div>
				</c:forEach>
