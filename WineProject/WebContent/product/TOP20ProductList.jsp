							...
							<c:forEach var="product" items="${list}" begin="${pageIndex}"
								...
								<a style="text-decoration: none;"
									...
									<div name="g_wall" class="g_wall drop-shadow"
											...
											<div name="g_wall_info">
												<span class="lebel_discribe">酒莊:</span><span>${product.p_winery}</span><Br>
													<span class="lebel_discribe">地區:</span><span>${product.p_area}</span><Br>
														<span class="lebel_discribe">評分:</span> <c:forEach var="i"
															begin="1" end="${ product.p_rate }" step="1">
															<img src="<%=request.getContextPath()%>/images/star1.gif"
																style="width: 16px; margin-left: -4px;">
														</c:forEach> <c:forEach var="i" begin="${ product.p_rate }" end="4"
															step="1">
										...
										<br class="clear" />
										<div name="g_wall_price">
											<span
												style="display: block; margin: 0px 0 0 15px; color: red; font-size: 22px">
												<span class="label label-important"
												style="background: #B41E3C; padding: 7px; font-size: 16px; background-image: -moz-linear-gradient(top, rgb(192, 49, 169), rgb(122, 5, 52)); background-image: -webkit-gradient(linear, 0 0, 0 100%, from(rgb(192, 49, 169)), to(rgb(122, 5, 52))); background-image: -webkit-linear-gradient(top, rgb(192, 49, 169), rgb(122, 5, 52));">優惠價</span>
												${product.p_price} 元
											</span>
										</div>
										...
										<div name="g_wall_name" class="g_wall_name">
											<span
												style="padding-left: 30px; display: block; height: 49px; margin-right: -10px; background: url(http://static.womai.com/zhongliang/templets/Winex/images/icon_12.png) no-repeat 0 8px;">${product.p_name}</span>
										</div>
									</div>
								</a>
							</c:forEach>
