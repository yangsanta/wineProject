...
<body >
	<div>
		<form id="MyForm" width="300px" align=center title="酒迷網" subtitle="會員資料修改" method="post" action="mem.do">
			...
			<p align=right>e-Mail：<input type="text" name="m_email" value="${memberVO.m_email}"/></p>
			<p align=right>姓名：<input type="text" name="m_name" require="true" label="賬號" value="${memberVO.m_name}"/></p>
			<p align=right>生日：<input type="text" name="m_bday" value="${memberVO.m_bday}"/></p>
			<p align=right>行動電話：<input type="text" name="m_mobile" value="${memberVO.m_mobile}"/></p>
			...
			<p align=right>狀態：<input type="hidden" name="m_status" value="${memberVO.m_status}"/></p>
