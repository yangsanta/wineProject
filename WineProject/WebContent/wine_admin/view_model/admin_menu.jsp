...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
		...
		<ul class="tabset buttons">
			...
			<li><a href="DiscussionManagment?action=getAll" class="ico5"><span>討論區管理</span><font
			...
			<li><a href="ademin_discount.jsp" class="ico5"><span>>首頁廣告</span><font
					class="text_con">首頁廣告</font><em></em></a> <span class="tooltip"><span>首頁右邊的廣告</span></span>
			</li>
			<li><a href="set_timing_sales?action=getAll" class="ico5"><span>>每日限時</span><font
					class="text_con">每日限時</font><em></em></a> <span class="tooltip"><span>首頁的每日限時商品</span></span>
			</li>			
			
			
			</a> <span class="num">常用</span> <span class="tooltip"><span>首頁廣告</span></span>
			</li>
