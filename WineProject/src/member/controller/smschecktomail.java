...
public class smschecktomail extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (smscheck.equals(smscheck_num)) {
			...
			memberVo.setM_no(db_member.getM_no());
