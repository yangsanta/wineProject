...
public class MemberVO implements java.io.Serializable {
	...
	private Integer m_smscheck = null;
	private String m_fbuid = null;
	...
	public Integer getM_smscheck() {
		return m_smscheck;
	}

	public void setM_smscheck(Integer m_smscheck) {
		this.m_smscheck = m_smscheck;
	}

	public String getM_fbuid() {
		return m_fbuid;
	}

	public void setM_fbuid(String m_fbuid) {
		this.m_fbuid = m_fbuid;
	}
}
